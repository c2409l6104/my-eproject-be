...
<body>
    <div class="login-card">
        ...
        <form action="login.php" method="post">
            ...
            <div class="form-group mb-3">
                <input type="submit" value="Log in" name="login" class="btn btn-primary btn-custom">
            </div>
        ...
        <div class="text-center">
            <a href="registration.php" class="btn btn-success btn-custom">Create new account</a>
        </div>
    </div>
    <script>
